...
public class RouterRest {
        ...
        public RouterFunction<ServerResponse> technologyRouterFunction(Handler handler) {
                return route(POST(TECHNOLOGIES_PATH), handler::listenRegisterTechnology)
                                .andRoute(POST(TECHNOLOGIES_EXISTENCE_CHECK_PATH), handler::listenCheckTechnologiesExistence)
                                .andRoute(POST(CAPABILITY_TECHNOLOGIES_PATH), handler::listenLinkCapabilityTechnologies)
                                .andRoute(DELETE(CAPABILITY_TECHNOLOGIES_BY_ID_PATH), handler::listenDeleteCapabilityTechnologies)
                                .andRoute(POST(CAPABILITY_TECHNOLOGIES_BY_CAPABILITY_IDS_PATH), handler::listenFindTechnologiesByCapabilityIds);
        }
}
